...
import 'package:flutter_frame_demo/utils/utils.dart';
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              width: getDeviceWidth(context) - 80,
              child: TextField(
                decoration: const InputDecoration(hintText: '请输入端口'),
            ...
            Container(
              ...
              height: 50,
              child: TextButton(child: const Text('设置代理'), onPressed: () => setupProxy()),
            )
          ],
        ),
      ),
